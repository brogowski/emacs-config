...
(custom-set-variables
 ...
 '(package-selected-packages
   '(org doom-themes which-key doom-modeline marginalia orderless vertigo vertico use-package clj-refactor magit tagedit rainbow-delimiters projectile smex ido-completing-read+ cider clojure-mode-extra-font-locking clojure-mode paredit exec-path-from-shell)))
(custom-set-faces
